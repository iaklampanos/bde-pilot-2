...
function addTableRow(name, typeF) {
    ...
    groupButtons.appendChild(element);
    if ( !((typeF == "kml") || (typeF == "gml") || (typeF == "geojson") || (typeF == "topojson") || (typeF == "changeset")) ) {
    	element.disabled = true;
    }
    ...
    element = document.createElement("button");
    element.type = "button";
    element.id = 'downloadLayerButton'+name;
    ...
    element.onclick = function () {
        ...
        switch (mapLayers[layerPosition].type) {
        	...
        	case 'gml':
        		...
        		break;
        	case 'geojson':
        		file.download = mapLayers[layerPosition].name + '.geojson';
        		break;
        	case 'topojson':
        		file.download = mapLayers[layerPosition].name + '.json';
        		break;
        	default:
    ...
    groupButtons.appendChild(element);
    if (typeF.substring(0,3) == "wms" || hasURI == 'dragAndDrop') {
    	element.disabled = true;
    }
