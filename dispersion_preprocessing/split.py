...
if __name__ == '__main__':
    ...
    for pos,f in enumerate(fidx):
        try:
            ...
            date = filelist[f].split('.')[2]
            for ff in range(fidx[pos],fidx[pos+1]):
                os.system('mv '+inp+filelist[ff]+' /home/wrf/Build_WRF/LIBRARIES/WRFV3/run/')
            nwrf = open('/home/wrf/data/tempnamelist.input','r')
